const verifyEmailTemplate = (token, email) => {
  return `<!doctype html>
                            ...
                            <div style="width: 100%;padding:0px;">
                                ...
                                <tbody>
                                    ...
                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                                        ...
                                        <a target="_blank" href="http://localhost:3000/api/v1/users/verfiyEmail/${token}" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;text-align: center;color: #FFFFFF; background-color: #ff6600; border-radius: 4px;  width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; font-size: 14px;">
