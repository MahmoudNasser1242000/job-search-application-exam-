const verifyPasswordTemplate = (otp, email) => {
    return (`<!doctype html>
                    ...
                    <div style="width: 100%;padding:0px;">
                        ...
                        <tbody>
                            ...
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 28px; line-height: 39.2px;"><strong>Verify Your Password </strong></span></p>
                                </div>
                    ...
                    <div style="width: 100%;padding:0px;">
                        ...
                        <tbody>
                            ...
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                ...
                                <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">You're almost ready to get started. Please copy the OTP&nbsp; below to verify your password and enjoy exclusive cleaning services with us! </span></p>
                                </div>
...
export default verifyPasswordTemplate;